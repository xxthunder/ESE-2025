...
Unsere CI-Reise begann 2005 in der Automobilzulieferindustrie. Der Ausgangspunkt war ernüchternd: Kein einziger Unit-Test im Repository, keine Testautomatisierung, nur Nightly Builds mit dem höchsten Qualitätskriterium "Software linkbar". Tests fanden primär im Fahrversuch statt. Wir nannten diesen Zustand "Continuous Kind im Brunnen" — reaktiv statt präventiv.
...
<!-- Abbildung 2: Pytest-Codebeispiel mit Marker-basierten Quality Gates (Test_MyVariant). Quelle: eigene Darstellung -->
